...
.rg-fm-playbtn:hover {
  ...
  box-shadow: 0 6px 24px rgba(224,90,0,0.55);
}
...
(function () {
  ...
  /* ============================================================
     FOCUS MODE — triggered when user arrives via shared link
     ============================================================ */
  function activateFocusMode() {
    var section = document.getElementById('rg-fm-section');
    if (!section) return;

    /* ---- Overlay — dims everything behind the player ---- */
    ...
    /* ---- Focus ring around the player card ---- */
    ...
    /* ---- "Back to full page" banner ---- */
    var banner = document.createElement('div');
    banner.id = 'rg-fm-focus-banner';
    banner.innerHTML =
      '<div class="rg-focus-inner">' +
        '<span class="rg-focus-dot"></span>' +
        '<span class="rg-focus-msg">' +
          '<strong>Global+ FM</strong> — Partagé avec vous via RayGlobals' +
        '</span>' +
        '<button class="rg-focus-close" id="rg-focus-close-btn">' +
          '<i class="fa fa-th-large"></i> Voir la page complète' +
        '</button>' +
      '</div>';
    ...
    requestAnimationFrame(function () {
      requestAnimationFrame(function () {
        ...
        section.style.boxShadow = '0 0 0 4px #e05a00, 0 0 60px rgba(224,90,0,0.3)';
    ...
    /* clicking the overlay also exits */
  ...
  /* ============================================================
     ...
     ============================================================ */
  function checkSharedArrival() {
    if (window.location.hash === '#rg-fm-section') {
      /* small delay so page finishes painting */
      setTimeout(activateFocusMode, 600);
    }
  }
  ...
  function doShare() {
    ...
    if (navigator.share) {
      navigator.share(SHARE_META).catch(function () { /* cancelled */ });
      return;
    }
    /* Desktop — clipboard */
  ...
  audio.addEventListener('playing', function () {
    if (playing) status.textContent = '● EN DIRECT — Global+ FM';
  });
