		...
		<div class="row">
			<div class="col-xs-12 col-sm-8">
				<h3 class="content-title">
                    <a href="<?=DNADMIN?>"><i class="fa fa-book fa-lg pink-col"></i></a> <small> <i class="fa fa-angle-double-right"></i> </small> Sales Revenue by Serie
				</h3>
			</div>
          ...
          <div class="col-sm-12 col-md-12">
              ...
              <div>
                ...
                <?php 
                    ...
                    $search_sql = "";
                    $search_form = false;
                    $sql_val_array = array('Deleted','PREMIUM');
                        ...
                        <table class="table no-margin">
                          ...
                          <tbody>
                            ...
                            <?php
                                ...
                                $storiSerieTable->selectQuery("SELECT* FROM `stori_serie` WHERE `state`!=? AND `package_type`=?  $search_sql ORDER BY {$_SESSION['participant_sort']}",$sql_val_array);
                                ...
                                if(Input::checkInput('keyword','get','0') ){
                                  ...
                                  $storiSerieTable = new StoriSerie();
                                  $storiSerieTable->selectQuery("SELECT * FROM `stori_serie` WHERE `state`!=? AND `package_type`=?  $search_sql ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}",$sql_val_array);
								...
								if($storiSerieTable->count()){
									...
									foreach($storiSerieTable->data() as $participant_data){
                                        ...
                                        $params_array = array($participant_ID,'APPROVED');
                                        $storiSubscriptionTable->selectQuery("SELECT `amount` FROM `stori_subscription` WHERE `serie_ID`=? AND `transaction_status`=? ORDER BY `ID` DESC",$params_array);
                                        ...
                                        if($storiSubscriptionTable->count()){
                                            ...
                                            foreach($storiSubscriptionTable->data() as $stori_subscription_data){
                                                ...
                                                $total_amount += $stori_subscription_data->amount;
                                                  ...
                                                  <div class="modal-body" style="background: #dedede">
                                                        ...
                                                        <div class="box" style="border-top: 0px;">
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <hr>
                                                                <p>
                                                                    <label class="product_title">Revenue: </label> <?=$total_amount?> RWF
                                                                </p>
                                                                <hr>
                                                                <p>
                                                                ...
                                                                <hr>
                                                                <p>
                                                                    <label class="product_title">Language: </label> <?=$participant_data->language?>
                                                                </p>
                                                                <hr>
