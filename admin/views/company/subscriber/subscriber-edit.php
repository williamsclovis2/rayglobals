                    ...
                    <div class="box-body" style="padding: 30px; ">
						...
						<div class="form-group">
							...
							<select name="user-groups" class="form-control">
								...
								<?php if($session_user_data->groups == "Admin" || $session_user_data->groups == "Smartafrica-Admin"){?>
								<option value="Smartafrica-Admin" <?php if($user_data->groups == 'Smartafrica-Admin'){ echo 'selected';}?>>Smartafrica-Admin</option>
								<option value="RG-Admin" <?php if($user_data->groups == 'RG-Admin'){ echo 'selected';}?>>RG-Admin</option>
								<?php }?>
							</select>
						</div>
                    </div>
