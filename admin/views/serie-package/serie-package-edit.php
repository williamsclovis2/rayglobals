		...
		<div class="row">
			<div class="col-xs-12 col-sm-8">
				<h3 class="content-title">
                    <a href="<?=DNADMIN?>"><i class="fa fa-book fa-lg pink-col"></i></a> <small> <i class="fa fa-angle-double-right"></i> </small> Edit package
				</h3>
			</div>
              ...
              <form method="post" id="reg-form" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header ui-sortable-handle" style="cursor: move;">
                      ...
                      <h3 class="box-title"><?=$stori_serie_package_data->code?></h3>
                    ...
                    <?php }else{ ?>
                        ...
                        <div class="box-body" style="padding: 10px 25px 10px 25px; ">
                            <fieldset class="panel-reg">
                                 ...
                                 <div class="form-group">
                                  <div class="col-sm-12">
                                      <h4 class="fieldset-header">Package Information <span class="req"></span></h4>
                                     <hr class="halfLine">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                    <textarea type="text" class="form-control" name="register-description" id="description" placeholder="Description" ><?=$stori_serie_package_data->description?></textarea>
                                  </div>
                                </div>
                                
                                <div class="form-group">
                                  <label class="control-label col-sm-3" for="package_type">Featured photo
                                    <span  class="req">*</span> 
                        ...
                        <div class="box-footer clearfix">
                            ...
                            <a href="<?=DNADMIN?>/app/serie-package/list" class="btn btn-default"><i class="glyphicon glyphicon-remove"></i> Cancel</a>
                                                                                  
                            
                            <input type="hidden" name="request" value="serie-package-edit">
                            <input type="hidden" name="id" value="<?=$stori_serie_package_data->ID?>">
