<?php
	function genCountry(){
		...
		$countries[] = array("code"=>"GF","name"=>"French Guiana","d_code"=>"+594","icon"=>"French_Guiana.png");
		$countries[] = array("code"=>"PF","name"=>"French Polynesia","d_code"=>"+689","icon"=>"French_Polynesia.png");
		...
		$countries[] = array("code"=>"BL","name"=>"Saint Barthelemy" ,"d_code"=>"+590","icon"=>"Saint_Barthelemy.png");
		$countries[] = array("code"=>"SH","name"=>"Saint Helena","d_code"=>"+290","icon"=>"Saint_Helena.png");
		$countries[] = array("code"=>"KN","name"=>"Saint Kitts and Nevis","d_code"=>"+1","icon"=>"St_Kitts_Nevis.png");
		$countries[] = array("code"=>"MF","name"=>"Saint Martin","d_code"=>"+590","icon"=>"Saint_Martin.png");
		$countries[] = array("code"=>"PM","name"=>"Saint Pierre and Miquelon","d_code"=>"+508","icon"=>"Saint_Pierre_and_Miquelon.png");
		...
		$countries[] = array("code"=>"BS","name"=>"The Bahamas","d_code"=>"+1","icon"=>"Bahamas.png");
