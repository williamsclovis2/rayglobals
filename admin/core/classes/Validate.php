...
class Validate {
    ...
    public function autoUniqueMaker($table, $item, $value, $middle = '') {
        ...
        while ($this->_db->get(array($item), $table, array($item, '=', $temp_val))->count()) {
            $num++;
    ...
    private function addError($error, $location = null) {
        $this->_errors[] = $error;
        if (!empty($location)) {
    ...
    public static function paidPass($pass) {
        if ($pass == 'Silver' ||
                ...
                $pass == 'Individual-Silver' ||
                $pass == 'Individual-Gold' ||
                $pass == 'Individual-Platinum' ||
                $pass == 'Individual-Silver-Discounted' ||
                $pass == 'Individual-Gold-Discounted' ||
                $pass == 'Individual-Platinum-Discounted' ||
                $pass == 'Group-Silver' ||
                $pass == 'Group-Gold' ||
                $pass == 'Group-Platinum' ||
                $pass == 'Group-Silver-Discounted' ||
                $pass == 'Group-Gold-Discounted' ||
                $pass == 'Group-Platinum-Discounted' ||
                $pass == 'Exhibitor-Silver-Discounted' ||
                $pass == 'Exhibitor-Gold-Discounted' ||
                $pass == 'Exhibitor-Platinum-Discounted' ||
                $pass == 'Sponsor-Silver-Discounted' ||
                $pass == 'Sponsor-Gold-Discounted' ||
                $pass == 'Sponsor-Platinum-Discounted' ||
                $pass == 'Smart-Africa-Member-Silver-Discounted' ||
                $pass == 'Smart-Africa-Member-Gold-Discounted' ||
                $pass == 'Smart-Africa-Member-Platinum-Discounted' ||
                $pass == 'Face-the-Gorillas-Silver-Discounted' ||
                $pass == 'Face-the-Gorillas-Gold-Discounted' ||
                $pass == 'Face-the-Gorillas-Platinum-Discounted' ||
                $pass == 'Ms-Geek-2017-Silver-Discounted' ||
                $pass == 'Ms-Geek-2017-Gold-Discounted' ||
                $pass == 'Ms-Geek-2017-Platinum-Discounted' ||
